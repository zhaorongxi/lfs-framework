package com.lfs.cache.redis.config.model;

import com.lfs.base.exception.BusinessException;
import com.lfs.cache.base.CacheConstants;
 ...
 * @version Version 0.1
 */
public class RedisModelSentine implements Condition{
	
	private final Logger logger = LoggerFactory.getLogger(RedisModelSentine.class);
	...
	public boolean matches(ConditionContext context,AnnotatedTypeMetadata metadata) {
		...
		return  CacheConstants.REDIS_MODEL_SENTINE.equals(redisMode);
	}
